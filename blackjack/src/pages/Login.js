    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <a href="/"><h1 className="text-4xl text-center tracking-tight font-extrabold sm:text-5xl md:text-6xl lg:text-5xl xl:text-7xl text-cyan-600 ">Blackjack</h1></a>
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form className="space-y-4" action="#" onSubmit={this.handleSubmit}>
              ...
              <div>
                ...
                <button type="button" onClick={this.resetPassword} className=" font-medium text-cyan-600 hover:text-cyan-500 text-sm" >forgot your password?</button>
              </div>
