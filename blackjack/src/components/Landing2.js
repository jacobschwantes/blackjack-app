              ...
              >
                <div className="rounded-lg shadow-md bg-gray-50 ring-1 ring-black ring-opacity-5 overflow-hidden">
                  ...
                  <div className="px-2 pt-2 pb-3 space-y-1">
                    {navigation.map((item) => (
                        <HashLink className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50" to={item.href}>{item.name}
                      </HashLink>
                    ))}
                  </div>
                  <a
