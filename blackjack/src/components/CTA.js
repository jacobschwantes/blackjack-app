        ...
        <div className="lg:grid lg:grid-cols-12">
          ...
          <div className="relative bg-cyan-600 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
            <div className="hidden absolute inset-0 overflow-hidden rounded-3xl lg:block" aria-hidden="true">
              <svg
                className="absolute bottom-full left-full transform -translate-y-2/3 -translate-x-1/2 xl:bottom-auto xl:top-0 "
                width={404}
                height={384}
                fill="none"
                viewBox="0 0 404 384"
            ...
            <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
              ...
              <p className="text-lg text-white">
                Create an account for free and start improving your blackjack skills.
              </p>
              <a
