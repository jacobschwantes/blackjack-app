  ...
  render() {
    return (
      <div className="w-full h-full relative">
        {this.props.game_over && this.props.victor ? 
        <div className="w-full h-full z-10  absolute items-center justify-center flex animate-fade-in">
          <div className="bg-white border-gray-200 border-2 shadow-lg p-4 rounded-lg flex flex-col  items-center justify-center">
            <h1 className=" text-6xl italic font-bold m-4 text-gray-800 text-center  ">{this.props.victor === 'push' ? "It's a push!" : this.props.victor + ' Wins!'}</h1>
            <p className="bold text-2xl">{this.props.reason}</p>
      ...
      <h1 className="mx-2 text-center  text-xl mt-1">{this.props.turn === 'player' ? this.props.dealer_hidden_score : this.props.player_hard === 0 ? null : (this.props.dealer_soft !== this.props.dealer_hard && this.props.dealer_soft < 21 ? (this.props.dealer_soft + ' / ' + this.props.dealer_hard) : this.props.dealer_soft === 21 ? this.props.dealer_soft : this.props.dealer_hard )}</h1>
