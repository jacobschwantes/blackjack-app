        ...
        <div className="flex flex-col sm:space-x-5 sm:flex-row   animate-fade-in ">
            ...
            <div className="flex flex-col flex-grow">
                ...
                <div className="flex items-center w-full mt-2 -ml-1">
                    <div className="text-gray-100 bg-gray-600 rounded-full w-8 h-8 flex items-center justify-center text-center z-10 text-sm border-2 font-bold border-cyan-600">{props.lvl}</div>
                    <div className="relative -ml-1 flex-grow ">
                        <div className=" h-1  text-xs flex rounded bg-gray-600">
